...
model_dir = "./trained_model"  # Updated to match the training script's output directory
...
print("Loading model...")
# Optionally configure BitsAndBytes for 8-bit loading
# Uncomment the following lines if you wish to use 8-bit inference
# bnb_config = BitsAndBytesConfig(load_in_8bit=True)
# model = AutoModelForCausalLM.from_pretrained(
#     model_dir,
#     quantization_config=bnb_config,
#     torch_dtype=torch.float16,  # Keep float16 for computation
#     device_map="auto"
# )

# Load the trained model without 8-bit quantization
model = AutoModelForCausalLM.from_pretrained(
    model_dir,
