...
def save_checkpoint(epoch, batch_idx, model, optimizer, scaler, losses, checkpoint_dir='checkpoints_llama_3', local_rank=0, enable_logging=False, logger=None, max_checkpoints=5):
    """
...
def find_latest_checkpoint(checkpoint_dir='checkpoints_llama_3', len_dataloader=None):
    """
...
def main():
    ...
    try:
        ...
        data_path = '../data_generation/output_with_restaurants_full.csv'
        ...
        latest_checkpoint_path = find_latest_checkpoint(checkpoint_dir='checkpoints_llama_3', len_dataloader=len_dataloader)
        ...
        checkpoint_dir = 'checkpoints_llama_3'
        os.makedirs(checkpoint_dir, exist_ok=True)
