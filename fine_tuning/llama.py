...
def save_checkpoint(epoch, batch_idx, model, optimizer, scaler, losses, checkpoint_dir='checkpoints_llama_2', local_rank=0, enable_logging=False, logger=None, max_checkpoints=5):
    """
...
def find_latest_checkpoint(checkpoint_dir='checkpoints_llama_2', len_dataloader=None):
    """
...
def main():
    ...
    try:
        ...
        model_name = "meta-llama_2/llama_2-3.1-8B"
        ...
        # Configure LoRA with updated target modules based on llama_2's architecture
        ...
        data_path = '../data_generation/output_with_restaurants_cleaned.csv'
        ...
        latest_checkpoint_path = find_latest_checkpoint(checkpoint_dir='checkpoints_llama_2', len_dataloader=len_dataloader)
        ...
        checkpoint_dir = 'checkpoints_llama_2'
        os.makedirs(checkpoint_dir, exist_ok=True)
